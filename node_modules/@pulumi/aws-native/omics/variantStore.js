...
exports.VariantStore = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Definition of AWS::Omics::VariantStore Resource Type
 */
class VariantStore extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new VariantStore(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.VariantStore = VariantStore;
/** @internal */
VariantStore.__pulumiType = 'aws-native:omics:VariantStore';
