...
exports.getGatewayOutput = exports.getGateway = exports.getFlowVpcInterfaceOutput = exports.getFlowVpcInterface = exports.getFlowSourceOutput = exports.getFlowSource = exports.getFlowEntitlementOutput = exports.getFlowEntitlement = exports.getFlowOutput = exports.getFlow = exports.getBridgeSourceOutput = exports.getBridgeSource = exports.getBridgeOutputResourceOutput = exports.getBridgeOutputResource = exports.getBridgeOutput = exports.getBridge = exports.Gateway = exports.FlowVpcInterface = exports.FlowSource = exports.FlowOutput = exports.FlowEntitlement = exports.Flow = exports.BridgeSource = exports.BridgeOutputResource = exports.Bridge = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.Bridge = null;
utilities.lazyLoad(exports, ["Bridge"], () => require("./bridge"));
exports.BridgeOutputResource = null;
utilities.lazyLoad(exports, ["BridgeOutputResource"], () => require("./bridgeOutputResource"));
exports.BridgeSource = null;
utilities.lazyLoad(exports, ["BridgeSource"], () => require("./bridgeSource"));
exports.Flow = null;
utilities.lazyLoad(exports, ["Flow"], () => require("./flow"));
exports.FlowEntitlement = null;
utilities.lazyLoad(exports, ["FlowEntitlement"], () => require("./flowEntitlement"));
exports.FlowOutput = null;
utilities.lazyLoad(exports, ["FlowOutput"], () => require("./flowOutput"));
exports.FlowSource = null;
utilities.lazyLoad(exports, ["FlowSource"], () => require("./flowSource"));
exports.FlowVpcInterface = null;
utilities.lazyLoad(exports, ["FlowVpcInterface"], () => require("./flowVpcInterface"));
exports.Gateway = null;
utilities.lazyLoad(exports, ["Gateway"], () => require("./gateway"));
exports.getBridge = null;
exports.getBridgeOutput = null;
utilities.lazyLoad(exports, ["getBridge", "getBridgeOutput"], () => require("./getBridge"));
exports.getBridgeOutputResource = null;
exports.getBridgeOutputResourceOutput = null;
utilities.lazyLoad(exports, ["getBridgeOutputResource", "getBridgeOutputResourceOutput"], () => require("./getBridgeOutputResource"));
exports.getBridgeSource = null;
exports.getBridgeSourceOutput = null;
...
exports.getFlowEntitlement = null;
exports.getFlowEntitlementOutput = null;
utilities.lazyLoad(exports, ["getFlowEntitlement", "getFlowEntitlementOutput"], () => require("./getFlowEntitlement"));
exports.getFlowSource = null;
exports.getFlowSourceOutput = null;
utilities.lazyLoad(exports, ["getFlowSource", "getFlowSourceOutput"], () => require("./getFlowSource"));
exports.getFlowVpcInterface = null;
exports.getFlowVpcInterfaceOutput = null;
...
// Export enums:
__exportStar(require("../types/enums/mediaconnect"), exports);
const _module = {
    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "aws-native:mediaconnect:BridgeOutputResource":
                return new exports.BridgeOutputResource(name, undefined, { urn });
            case "aws-native:mediaconnect:BridgeSource":
                return new exports.BridgeSource(name, undefined, { urn });
            case "aws-native:mediaconnect:Flow":
                return new exports.Flow(name, undefined, { urn });
            case "aws-native:mediaconnect:FlowEntitlement":
                return new exports.FlowEntitlement(name, undefined, { urn });
            case "aws-native:mediaconnect:FlowOutput":
                return new exports.FlowOutput(name, undefined, { urn });
            case "aws-native:mediaconnect:FlowSource":
                return new exports.FlowSource(name, undefined, { urn });
            case "aws-native:mediaconnect:FlowVpcInterface":
                return new exports.FlowVpcInterface(name, undefined, { urn });
