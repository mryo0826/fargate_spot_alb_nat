...
exports.FlowOutput = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Resource schema for AWS::MediaConnect::FlowOutput
 */
class FlowOutput extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new FlowOutput(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.FlowOutput = FlowOutput;
/** @internal */
FlowOutput.__pulumiType = 'aws-native:mediaconnect:FlowOutput';
