...
exports.WirelessDevice = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Create and manage wireless gateways, including LoRa gateways.
 */
class WirelessDevice extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new WirelessDevice(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.WirelessDevice = WirelessDevice;
/** @internal */
WirelessDevice.__pulumiType = 'aws-native:iotwireless:WirelessDevice';
