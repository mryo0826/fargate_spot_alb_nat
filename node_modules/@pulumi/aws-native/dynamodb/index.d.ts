...
export declare const getGlobalTable: typeof import("./getGlobalTable").getGlobalTable;
export declare const getGlobalTableOutput: typeof import("./getGlobalTable").getGlobalTableOutput;
