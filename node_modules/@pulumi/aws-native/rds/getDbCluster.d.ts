 ...
 */
export declare function getDbCluster(args: GetDbClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetDbClusterResult>;
...
export interface GetDbClusterResult {
     ...
     *  Valid for: Aurora DB clusters and Multi-AZ DB clusters
     */
    readonly associatedRoles?: outputs.rds.DbClusterDbClusterRole[];
    /**
 ...
 *  The default ``DeletionPolicy`` for ``AWS::RDS::DBCluster`` resources is ``Snapshot``. For more information about how AWS CloudFormation deletes resources, see [DeletionPolicy Attribute](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-deletionpolicy.html).
 */
export declare function getDbClusterOutput(args: GetDbClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbClusterResult>;
