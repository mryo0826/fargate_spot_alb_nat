...
exports.IdNamespace = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * IdNamespace defined in AWS Entity Resolution service
 */
class IdNamespace extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new IdNamespace(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.IdNamespace = IdNamespace;
/** @internal */
IdNamespace.__pulumiType = 'aws-native:entityresolution:IdNamespace';
