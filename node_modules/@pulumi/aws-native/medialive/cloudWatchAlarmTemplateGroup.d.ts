 ...
 */
export declare class CloudWatchAlarmTemplateGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CloudWatchAlarmTemplateGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is CloudWatchAlarmTemplateGroup;
    /**
