 ...
 */
export declare class ContainerFleet extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ContainerFleet;
    /**
     * Returns true if the given object is an instance of ContainerFleet.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ContainerFleet;
    /**
     * Indicates whether to use On-Demand instances or Spot instances for this fleet. If empty, the default is ON_DEMAND. Both categories of instances use identical hardware and configurations based on the instance type selected for this fleet.
     */
    readonly billingType: pulumi.Output<enums.gamelift.ContainerFleetBillingType | undefined>;
    /**
     ...
     */
    readonly deploymentConfiguration: pulumi.Output<outputs.gamelift.ContainerFleetDeploymentConfiguration | undefined>;
    readonly deploymentDetails: pulumi.Output<outputs.gamelift.ContainerFleetDeploymentDetails>;
    /**
     ...
     */
    readonly fleetRoleArn: pulumi.Output<string>;
    /**
     ...
     */
    readonly gameServerContainerGroupDefinitionArn: pulumi.Output<string>;
    /**
     ...
     */
    readonly gameServerContainerGroupDefinitionName: pulumi.Output<string | undefined>;
    /**
     * The number of desired game server container groups per instance, a number between 1-5000.
     */
    readonly gameServerContainerGroupsPerInstance: pulumi.Output<number | undefined>;
    /**
     * A policy that limits the number of game sessions an individual player can create over a span of time for this fleet.
     */
    readonly gameSessionCreationLimitPolicy: pulumi.Output<outputs.gamelift.ContainerFleetGameSessionCreationLimitPolicy | undefined>;
    /**
     * The set of port numbers to open on each instance in a container fleet. Connection ports are used by inbound traffic to connect with processes that are running in containers on the fleet.
     */
    readonly instanceConnectionPortRange: pulumi.Output<outputs.gamelift.ContainerFleetConnectionPortRange | undefined>;
    /**
     * A range of IP addresses and port settings that allow inbound traffic to connect to server processes on an Amazon GameLift server.
     */
    readonly instanceInboundPermissions: pulumi.Output<outputs.gamelift.ContainerFleetIpPermission[] | undefined>;
    /**
     ...
     */
    readonly logConfiguration: pulumi.Output<outputs.gamelift.ContainerFleetLogConfiguration | undefined>;
    /**
     * The maximum number of game server container groups per instance, a number between 1-5000.
     */
    readonly maximumGameServerContainerGroupsPerInstance: pulumi.Output<number>;
    /**
     ...
     */
    readonly newGameSessionProtectionPolicy: pulumi.Output<enums.gamelift.ContainerFleetNewGameSessionProtectionPolicy | undefined>;
    /**
     ...
     */
    readonly perInstanceContainerGroupDefinitionArn: pulumi.Output<string>;
    /**
     ...
     */
    readonly perInstanceContainerGroupDefinitionName: pulumi.Output<string | undefined>;
    /**
     * A list of rules that control how a fleet is scaled.
     */
    readonly scalingPolicies: pulumi.Output<outputs.gamelift.ContainerFleetScalingPolicy[] | undefined>;
    /**
     * The current status of the container fleet.
     */
    readonly status: pulumi.Output<enums.gamelift.ContainerFleetStatus>;
    /**
