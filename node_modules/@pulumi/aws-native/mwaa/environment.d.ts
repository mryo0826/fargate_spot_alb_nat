...
export declare class Environment extends pulumi.CustomResource {
     ...
     */
    readonly celeryExecutorQueue: pulumi.Output<string>;
    /**
     ...
     */
    readonly endpointManagement: pulumi.Output<enums.mwaa.EnvironmentEndpointManagement | undefined>;
    /**
     ...
     */
    readonly maxWebservers: pulumi.Output<number | undefined>;
    /**
     ...
     * Valid values: For environments larger than mw1.micro, accepts values from `2` to `5` . Defaults to `2` for all environment sizes except mw1.micro, which defaults to `1` .
     */
    readonly minWebservers: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly startupScriptS3ObjectVersion: pulumi.Output<string | undefined>;
    /**
