...
export declare const AlarmModel: typeof import("./alarmModel").AlarmModel;
export { DetectorModelArgs } from "./detectorModel";
export type DetectorModel = import("./detectorModel").DetectorModel;
export declare const DetectorModel: typeof import("./detectorModel").DetectorModel;
export { GetAlarmModelArgs, GetAlarmModelResult, GetAlarmModelOutputArgs } from "./getAlarmModel";
export declare const getAlarmModel: typeof import("./getAlarmModel").getAlarmModel;
export declare const getAlarmModelOutput: typeof import("./getAlarmModel").getAlarmModelOutput;
export { GetDetectorModelArgs, GetDetectorModelResult, GetDetectorModelOutputArgs } from "./getDetectorModel";
export declare const getDetectorModel: typeof import("./getDetectorModel").getDetectorModel;
export declare const getDetectorModelOutput: typeof import("./getDetectorModel").getDetectorModelOutput;
