 ...
 */
export declare class ApplicationFleetAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApplicationFleetAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is ApplicationFleetAssociation;
    /**
