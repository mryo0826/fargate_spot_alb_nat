...
exports.EnvironmentActions = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Definition of AWS::DataZone::EnvironmentActions Resource Type
 */
class EnvironmentActions extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new EnvironmentActions(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
EnvironmentActions.__pulumiType = 'aws-native:datazone:EnvironmentActions';
//# sourceMappingURL=environmentActions.js.map