...
class VpcIngressConnection extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new VpcIngressConnection(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
VpcIngressConnection.__pulumiType = 'aws-native:apprunner:VpcIngressConnection';
