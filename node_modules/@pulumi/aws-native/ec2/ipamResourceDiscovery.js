...
exports.IpamResourceDiscovery = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Resource Schema of AWS::EC2::IPAMResourceDiscovery Type
 */
class IpamResourceDiscovery extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new IpamResourceDiscovery(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.IpamResourceDiscovery = IpamResourceDiscovery;
/** @internal */
IpamResourceDiscovery.__pulumiType = 'aws-native:ec2:IpamResourceDiscovery';
//# sourceMappingURL=ipamResourceDiscovery.js.map