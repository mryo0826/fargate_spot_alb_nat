 ...
 */
export declare class TransitGatewayRouteTablePropagation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TransitGatewayRouteTablePropagation;
    /**
     ...
     */
    static isInstance(obj: any): obj is TransitGatewayRouteTablePropagation;
    /**
