 ...
 */
export declare function getScalableTarget(args: GetScalableTargetArgs, opts?: pulumi.InvokeOptions): Promise<GetScalableTargetResult>;
 ...
 *   If the resource that you want Application Auto Scaling to scale is not yet created in your account, add a dependency on the resource when registering it as a scalable target using the [DependsOn](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-dependson.html) attribute.
 */
export declare function getScalableTargetOutput(args: GetScalableTargetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScalableTargetResult>;
