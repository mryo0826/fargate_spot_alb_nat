...
exports.ScalingPolicy = exports.ScalableTarget = exports.getScalingPolicyOutput = exports.getScalingPolicy = exports.getScalableTargetOutput = exports.getScalableTarget = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.getScalableTarget = null;
exports.getScalableTargetOutput = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws-native:applicationautoscaling:ScalableTarget":
                return new exports.ScalableTarget(name, undefined, { urn });
