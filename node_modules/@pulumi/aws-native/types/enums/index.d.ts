...
export { amplify, amplifyuibuilder, apigateway, appconfig, appflow, applicationinsights, applicationsignals, apprunner, appsync, arczonalshift, athena, auditmanager, autoscaling, b2bi, backup, batch, bedrock, budgets, cassandra, ce, chatbot, cleanrooms, cleanroomsml, cloudformation, cloudfront, cloudtrail, codeartifact, codebuild, codeguruprofiler, codegurureviewer, codepipeline, codestarconnections, codestarnotifications, cognito, comprehend, connect, connectcampaignsv2, controltower, customerprofiles, databrew, datasync, datazone, deadline, devicefarm, devopsguru, dms, dynamodb, ec2, ecr, ecs, efs, eks, elasticache, emr, emrserverless, entityresolution, events, evidently, finspace, fis, fms, forecast, frauddetector, fsx, gamelift, globalaccelerator, glue, grafana, greengrassv2, groundstation, guardduty, healthimaging, healthlake, imagebuilder, inspectorv2, internetmonitor, iot, iotanalytics, iotevents, iotsitewise, iottwinmaker, iotwireless, ivs, ivschat, kafkaconnect, kendra, kinesis, kinesisanalyticsv2, kinesisfirehose, kinesisvideo, kms, lakeformation, lambda, launchwizard, lex, lightsail, location, logs, lookoutmetrics, m2, macie, mediaconnect, medialive, mediapackage, mediapackagev2, mediatailor, memorydb, msk, mwaa, networkfirewall, oam, omics, opensearchserverless, opensearchservice, organizations, osis, panorama, paymentcryptography, pcaconnectorad, pcaconnectorscep, pcs, personalize, pinpoint, pipes, proton, qbusiness, quicksight, rbin, rds, redshift, redshiftserverless, refactorspaces, resiliencehub, resourceexplorer2, resourcegroups, robomaker, rolesanywhere, route53, route53recoverycontrol, route53resolver, rum, s3, s3express, s3outposts, s3tables, sagemaker, scheduler, securityhub, securitylake, servicecatalog, servicecatalogappregistry, ses, shield, signer, sns, ssm, ssmcontacts, ssmincidents, ssmquicksetup, sso, stepfunctions, supportapp, synthetics, systemsmanagersap, timestream, transfer, verifiedpermissions, vpclattice, wafv2, wisdom, workspaces, workspacesthinclient, workspacesweb, };
