export declare const AllowListStatus: {
    readonly Ok: "OK";
    readonly S3ObjectNotFound: "S3_OBJECT_NOT_FOUND";
    readonly S3UserAccessDenied: "S3_USER_ACCESS_DENIED";
    readonly S3ObjectAccessDenied: "S3_OBJECT_ACCESS_DENIED";
    readonly S3Throttled: "S3_THROTTLED";
    readonly S3ObjectOversize: "S3_OBJECT_OVERSIZE";
    readonly S3ObjectEmpty: "S3_OBJECT_EMPTY";
...
export declare const FindingsFilterFindingFilterAction: {
...
export declare const SessionFindingPublishingFrequency: {
    readonly FifteenMinutes: "FIFTEEN_MINUTES";
    readonly OneHour: "ONE_HOUR";
    readonly SixHours: "SIX_HOURS";
};
/**
