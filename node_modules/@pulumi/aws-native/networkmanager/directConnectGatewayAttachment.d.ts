...
export declare class DirectConnectGatewayAttachment extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DirectConnectGatewayAttachment;
    /**
     ...
     */
    readonly proposedNetworkFunctionGroupChange: pulumi.Output<outputs.networkmanager.DirectConnectGatewayAttachmentProposedNetworkFunctionGroupChange | undefined>;
    /**
     * The attachment to move from one segment to another.
     */
    readonly proposedSegmentChange: pulumi.Output<outputs.networkmanager.DirectConnectGatewayAttachmentProposedSegmentChange | undefined>;
    /**
