...
export declare const getRecipe: typeof import("./getRecipe").getRecipe;
export declare const getRecipeOutput: typeof import("./getRecipe").getRecipeOutput;
...
export declare const Recipe: typeof import("./recipe").Recipe;
