...
exports.ProfileAssociation = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Resource Type definition for AWS::Route53Profiles::ProfileAssociation
 */
class ProfileAssociation extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new ProfileAssociation(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ProfileAssociation.__pulumiType = 'aws-native:route53profiles:ProfileAssociation';
