 ...
 */
export declare function getUserPolicy(args: GetUserPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetUserPolicyResult>;
 ...
 *  For information about the maximum number of inline policies that you can embed in a user, see [IAM and quotas](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_iam-quotas.html) in the *IAM User Guide*.
 */
export declare function getUserPolicyOutput(args: GetUserPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserPolicyResult>;
