...
exports.BatchScramSecret = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
/**
 * Resource Type definition for AWS::MSK::BatchScramSecret
 */
class BatchScramSecret extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, opts) {
        return new BatchScramSecret(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.BatchScramSecret = BatchScramSecret;
/** @internal */
BatchScramSecret.__pulumiType = 'aws-native:msk:BatchScramSecret';
//# sourceMappingURL=batchScramSecret.js.map